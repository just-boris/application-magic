...
build/main.pdf: img/distribution.png img/gauss3d.png strip_distribution.png img/intersection.png img/intersection2.png \
     ...
     img/angular_bevel.png img/longitudinal.png img/backreflection.png img/angular_reflection.png \
     ...
     img/gauss_divergence.pdf img/angular_movement.pdf img/backreflection_scheme.pdf img/heatmap.pdf
