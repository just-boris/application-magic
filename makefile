...
build/main.pdf: img/distribution_courning.png img/distribution_fog.png img/distribution_panda.png img/gauss3d.png \
     strip_distribution.png img/intersection.png img/intersection2.png img/transversal_fog.png \
     img/transversal_courning.png img/transversal_panda.png img/var_radius.png img/angular.png img/angular_bevel.png \
