...
build/main.pdf: img/distribution.png img/gauss3d.png strip_distribution.png img/intersection.png img/intersection2.png \
     ...
     img/angular_bevel.png img/longitudinal.png img/planar_propagation.pdf  img/refraction_full_inner.pdf  \
     img/refraction.pdf  img/transverse_movement.pdf img/cylinder_axes.pdf img/polozok_a.pdf img/polozok_b.pdf \
     img/polozok_c.pdf img/polozok_d.pdf img/polozok_e.pdf img/polozok_f.pdf img/cylinder_sf.pdf img/cylinder_dsf.pdf \
